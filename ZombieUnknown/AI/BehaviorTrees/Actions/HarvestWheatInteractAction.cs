...
{
    internal class HarvestWheatInteractAction : InteractAction
    {
        protected override GoalStatus Action(Blackboard blackboard)
        {
            var target = GameState.InteractionObject as Wheat;
            ...
            blackboard["TargetInteraction"] = InteractionManager.CreateTargetedInteraction(target, actor).ForInteraction<HarvestWheatInteraction>();
