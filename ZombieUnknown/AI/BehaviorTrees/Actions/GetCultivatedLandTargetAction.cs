...
{
    internal class GetCultivatedLandTargetAction : BehaviorAction
    {
        protected override GoalStatus Action(Blackboard blackboard)
        {
            var subject = GameState.InteractionObject as CultivatedLand;
            ...
            blackboard["TargetInteraction"] = TargetInteraction<CultivatedLand, Human, SowSeedsInteraction>.Create(subject, actor);
